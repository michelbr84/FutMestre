...
pub fn board_satisfaction(
    league_position: u8,
    expected_position: u8,
    financial_health: i64,
) -> u8 {
...
pub fn calculate_board_satisfaction(
    ...
    let financial_score = calculate_financial_score(financial_balance, expectations.financial_target);
...
mod tests {
    ...
    fn test_board_satisfaction_meeting_expectations() {
        ...
        assert!(satisfaction >= 50 && satisfaction <= 70, "Should be moderately satisfied");
    }
